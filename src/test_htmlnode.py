...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_repr_leaf(self):
        ...
        self.assertEqual(
            repr(node), "LeafNode(tag = p, value = This is a paragraph, props = None)"
        )
    ...
    def test_hyperlink_to_html(self):
        node = LeafNode("a", "click this link", {"href": "https://www.example.com"})
        self.assertEqual(
            node.to_html(), '<a href="https://www.example.com">click this link</a>'
        )
